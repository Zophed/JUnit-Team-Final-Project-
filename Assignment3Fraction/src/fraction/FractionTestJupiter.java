 ...
 * Zachary Riggle
 * 
 * 	This class will test the various functions provided within the Fraction class. It thoroughly
 * 		tests the various functions and ensures taht all fractions are displayed and calculated 
 * 		correctly.
 */
